 ...
 * *Performance:* Must be comparable to using the datastore APIs directly
 ...
 * A series of Quick* methods that ignore errors (i.e. <code>QuickFind</code> would return nil if no record could be found)
